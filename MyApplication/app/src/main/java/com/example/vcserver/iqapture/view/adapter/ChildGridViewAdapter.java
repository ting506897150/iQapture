...
public class ChildGridViewAdapter extends android.widget.BaseAdapter {
    ...
    public ChildGridViewAdapter(QuestionnaireActivity questionnaireActivity, List<LocalMedia> selectList) {
